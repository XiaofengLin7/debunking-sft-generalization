...
Adapted from https://github.com/RAGEN-AI/RAGEN/blob/main/ragen/llm_agent/ctx_manager.py#L91
date: 2025-04-29
"""
...
class NaiveContextManager(ContextManager):
    def __init__(self, 
        ...
        #     self.tokenizer.add_special_tokens({'pad_token_id': self.tokenizer.eos_token_id})
        self.processor = processor
        self.special_token_list = ["<think>", "</think>", "<answer>", "</answer>", "<|im_start|>", "<|im_end|>"]
