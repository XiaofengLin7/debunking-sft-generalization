...
DATA_DIR="./data/sokoban_one_horizon_small_envs"
...
KL_COEF=0.001
CONTEXT_LENGTH=512
EXPERIMENT_NAME="exp-0.5b-${BETA}beta-logic-with-kl-${KL_COEF}-${CONTEXT_LENGTH}-ctx-one-horizon-small-envs"
ROLLOUT_TP_SIZE=1
N_GPUS=1
...
custom_reward_function.name=compute_score_with_action_sequence 2>&1 | tee verl_demo_0.5b.log