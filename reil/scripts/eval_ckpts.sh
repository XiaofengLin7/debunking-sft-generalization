...
CHECKPOINT_DIR=/usr3/graduate/xfl/lab/REIL/checkpoints/ds543/REIL/alfworld-1.5b-0.0025beta-0.001kl-pick_n_place_05-11  # Directory containing checkpoints to evaluate
