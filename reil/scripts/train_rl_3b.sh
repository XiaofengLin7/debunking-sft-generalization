...
BETA=0.005
KL_COEF=0.001
EXPERIMENT_NAME="exp-3b-${BETA}beta-logic-with-kl-${KL_COEF}-4096-ctx"
ROLLOUT_TP_SIZE=2
N_GPUS=2
...
custom_reward_function.name=compute_score_with_action_sequence 2>&1 | tee verl_demo_3b.log
