...
EXPERIMENT_NAME="sokoban-1.5b-contrastive-qwen-2.5-base-full-sft-$(date +%m-%d)"
...
torchrun --standalone --nnodes=1 --nproc_per_node=$N_GPUS \
    ...
    trainer.default_local_dir=checkpoints/ds543/contrastive/$EXPERIMENT_NAME \
    trainer.logger="['console', 'wandb']" \
    trainer.total_epochs=30 \
    trainer.default_hdfs_dir=null $@ | tee checkpoints/ds543/contrastive/${EXPERIMENT_NAME}_train.log
