...
BASE_MODEL="/usr3/graduate/xfl/lab/REIL/checkpoints/sft/sokoban-1.5b-sft-qwen-2.5-base-full-sft-05-15/global_step_450"
BETA=0.0075
KL_COEF=0.001
CONTEXT_LENGTH=1024
BATCH_SIZE=256
EXPERIMENT_NAME="pretrain-sokoban-1.5b-${BETA}beta-${KL_COEF}kl-$(date +%m-%d)-grpo"
ROLLOUT_TP_SIZE=1
N_GPUS=4
...
es_manager.val.env_configs.tags=["LargerSokoban"] \
