...
CONTEXT_LENGTH=4096
BATCH_SIZE=128
EXPERIMENT_NAME="small_sokoban-r1-8b-${BETA}beta-${KL_COEF}kl-$(date +%m-%d)-grpo"
...
custom_reward_function.name=compute_score_with_action_sequence 2>&1 | tee sokoban_r1_8b.log
