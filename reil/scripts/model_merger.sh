...
checkpoint_dir="/usr3/graduate/xfl/lab/REIL/checkpoints/ds543/REIL/sokoban-1.5b-0.0075beta-0.001kl-2025-05-01/global_step_4000/actor"
...
python3 -m reil.utils.models.model_merger --backend fsdp \
    ...
    --hf_upload_path "Xiaofeng77/sokoban-1.5b-0.0075beta-0.001kl-2025-05-01"