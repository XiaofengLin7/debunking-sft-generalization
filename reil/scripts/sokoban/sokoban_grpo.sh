...
CONTEXT_LENGTH=1024
BATCH_SIZE=256
EXPERIMENT_NAME="sokoban-1.5b-${BETA}beta-${KL_COEF}kl-$(date +%m-%d)-grpo"
...
es_manager.val.env_configs.tags="['SimpleSokoban', 'LargerSokoban', 'ComplexSokoban', 'SimpleSokobanEmoji', 'FakeSokobanEmoji', 'SimpleSokobanCardinal', 'FakeSokobanCardinal', 'SimpleSokobanEmpty']" \
