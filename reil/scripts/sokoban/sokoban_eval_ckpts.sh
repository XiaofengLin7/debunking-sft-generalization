...
python -m reil.evaluation.eval_ckpts \
    ...
    es_manager.val.env_groups=1100 \
    es_manager.val.group_size=1 \
    es_manager.val.env_configs.tags="['SimpleSokoban', 'LargerSokoban', 'ComplexSokoban', 'SimpleSokobanEmoji', 'FakeSokobanEmoji', 'SimpleSokobanCardinal', 'FakeSokobanCardinal', 'SimpleSokobanEmpty', 'TwoBoxesSokoban', 'SimpleSokobanNumerical', 'SimpleSokobanAlphabetical']" \
    es_manager.val.env_configs.n_groups="[100,100,100,100,100,100,100,100,100,100,100]" \
