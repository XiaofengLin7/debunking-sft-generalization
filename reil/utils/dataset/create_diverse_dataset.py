...
def main():
    ...
    # push to hub
    train_dataset.push_to_hub("Xiaofeng77/reil_sokoban_diverse", split="train")
    test_dataset.push_to_hub("Xiaofeng77/reil_sokoban_diverse", split="test")
    test_env_dataset.push_to_hub("Xiaofeng77/reil_sokoban_diverse", split="test_env")
